...
dynogels.log = { child: () => dynogels.log };
dynogels.log.trace = dynogels.log.debug = dynogels.log.info = dynogels.log.warn =
dynogels.log.error = dynogels.log.fatal = () => {};
...
internals.compileModel = (name, schema) => {
  ...
  const log = dynogels.log && dynogels.log.child({ model: name });
