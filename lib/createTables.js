...
const async_doWhilst = require('async/doWhilst');
const async_eachSeries = require('async/eachSeries');
...
module.exports = (models, config, callback) => {
  async_eachSeries(_.keys(models), (key, callback) => internals.createTable(models[key], config.$dynogels, config[key], callback), callback);
};
